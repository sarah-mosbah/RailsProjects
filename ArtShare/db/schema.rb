...
ActiveRecord::Schema.define(version: 2020_11_06_193222) do
  ...
  create_table "art_work_shares", force: :cascade do |t|
    ...
    t.integer "viewer_id"
    t.index ["artwork_id", "viewer_id"], name: "index_art_work_shares_on_artwork_id_and_viewer_id", unique: true
    t.index ["artwork_id"], name: "index_art_work_shares_on_artwork_id"
